...
| A10     | コードリスト「都道府県コード」                                                                                                                                                        | 都道府県コード                 |
| A10     | コードリスト「支庁区分コード」                                                                                                                                                        | 支庁区分コード                 |
| A10     | コードリスト「自然公園地域区分コード」                                                                                                                                                | 自然公園地域区分コード         |
| A11     | コードリスト「都道府県コード」                                                                                                                                                        | 都道府県コード                 |
| A11     | コードリスト「支庁区分コード」                                                                                                                                                        | 支庁区分コード                 |
| A11     | コードリスト「自然保全地域区分コード」                                                                                                                                                | 自然保全地域区分コード         |
| A12     | コードリスト「都道府県コード」                                                                                                                                                        | 都道府県コード                 |
| A12     | コードリスト「支庁区分コード」                                                                                                                                                        | 支庁区分コード                 |
| A12     | コードリスト「農業地域区分コード」                                                                                                                                                    | 農業地域区分コード             |
| A13     | コードリスト「都道府県コード」                                                                                                                                                        | 都道府県コード                 |
| A13     | コードリスト「支庁区分コード」                                                                                                                                                        | 支庁区分コード                 |
| A13     | コードリスト「森林地域区分コード」                                                                                                                                                    | 森林地域区分コード             |
...
| A21     | コードリスト「都道府県コード」                                                                                                                                                        | 都道府県コード                 |
| A21     | コードリスト「支庁区分コード」                                                                                                                                                        | 支庁区分コード                 |

...
id_exception <- c("A16", "A22-m", "30b", "A34", "A35a", "A35b", "A37", "C23", "G02", "P15", "P16", "P17", "P18", "L03-a", "mesh1000", "mesh500", "P21", "N05")
...
```
    ...
    ## [13] "mesh500"  "N05"      "P15"      "P16"      "P17"      "P18"     
    ## [19] "P21"      "W09"     
    ## 
    ## $positional
    ##  [1] "A03"     "A17"     "A18"     "A18s-a"  "A19"     "A19s"    "A20s"   
    ##  [8] "A21s"    "A22s"    "A23"     "A24"     "A25"     "A26"     "A28"    
    ## [15] "C02"     "C09"     "L01"     "L02"     "L03-b"   "L03-b-u" "N04"    
    ## [22] "P02"     "P05"     "P07"     "P09"     "P11"     "S05-a"   "S05-b"  
    ## [29] "S05-c"   "W05"     "W07"
